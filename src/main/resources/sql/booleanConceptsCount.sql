SELECT * FROM (select base.age_group, person_id, base.concept_name, base.value_boolean, female, male, other, result.visit_id from
  ...
  ORDER BY result.obs_datetime DESC ) as result_data

  SELECT distinct answer.concept_full_name as concept_name,     
                  ...
                  IF(inpatient_outcome_obs.age_group_id IS NULL, 0, SUM(IF(inpatient_outcome_obs.gender = 'O', 1, 0))) AS other_count,
                  ...
                  cast(valid_coded_obs_view.obs_datetime as date) BETWEEN (DATE_ADD(DATE_ADD(person.birthdate, INTERVAL observed_age_group.min_years YEAR), INTERVAL observed_age_group.min_days DAY))

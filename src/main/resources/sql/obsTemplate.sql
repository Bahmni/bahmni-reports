                 ...
                 @sql,
                  ' FROM concept_view cv
                    ...
                    (SELECT
                       ...
                       pat.name    as patient_attr_name,
                       coalesce(person_attribute_cn.name, pattr.value) as patient_attr_value
                     FROM obs ob
                       ...
                       JOIN person_attribute_type pat ON pat.name in(#patientAttributesInClauseEscapeQuote#)
                       ...
                       LEFT JOIN concept_name person_attribute_cn ON pattr.value = person_attribute_cn.concept_id AND pat.format LIKE "%Concept"
                            AND person_attribute_cn.concept_name_type = "FULLY_SPECIFIED"

...
INNER JOIN concept_name concept ON concept.concept_id = pws.concept_id
LEFT JOIN patient_program pp ON pp.program_id = program.program_id
LEFT JOIN patient_state ps ON ps.patient_program_id = pp.patient_program_id and DATE(ps.start_date) BETWEEN "#startDate#" AND "#endDate#"

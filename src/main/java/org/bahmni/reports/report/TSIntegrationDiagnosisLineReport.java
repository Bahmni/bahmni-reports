...
public class TSIntegrationDiagnosisLineReport extends Report<TSIntegrationDiagnosisLineReportConfig> {
    private static final Logger logger = LogManager.getLogger(TSIntegrationDiagnosisLineReport.class);

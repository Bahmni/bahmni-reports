...
//                                ctab.measure("Male", "male_count", Integer.class, Calculation.SUM));
        ...
        report.setPageFormat(PageType.A3, PageOrientation.LANDSCAPE)
                ...
                .setDataSource(getSql("Inpatient Discharge Reports", "Inpatient Outcome"), dataSource.getConnection());
...
//        report.toHtml(response.getOutputStream());
    ...
    private static String getSql(final String ageGroupName, final String conceptFullName) {
        return " SELECT  distinct answer.concept_full_name as concept_name, " +
                        ...
                        " IF(required_obs.age_group_id IS NULL, 0, COUNT(person_id)) as total_count " +
                        ...
                        " WHERE valid_coded_obs_view.obs_datetime BETWEEN '2014-09-01' AND '2015-02-12' AND valid_coded_obs_view.concept_full_name = '" + conceptFullName + "' " +
